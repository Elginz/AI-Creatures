# THIS IS FOR SENSORY INPUTS TO TRAVEL UPSLOPE
...
class Genome():
    ...
    def get_gene_spec():
        gene_spec =  {"link-shape":{"scale":1}, 
            ...
            # additional genes
            "sensor-gain": {"scale":4.0},
            "sensor-bias": {"scale":2.0} 
            }
        ind = 0
    ...
    def get_gene_dict(gene, spec):
        ...
        for key in spec:
            ...
            # normalise for positive and negative values for the sensors
            if key in ["sensor-gain", "sensor-bias"]:
                gdict[key] = (gene[ind] - 0.5) * scale
            else:
    ...
    def genome_to_links(gdicts):
        ...
        for gdict in gdicts:
            ...
            link = URDFLink(name=link_name, 
                            ...
                            # added genes
                            sensor_gain=gdict["sensor-gain"],
                            sensor_bias=gdict["sensor-bias"])
            links.append(link)
